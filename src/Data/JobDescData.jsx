import { faClock, faTimesCircle, faTimesRectangle } from "@fortawesome/free-regular-svg-icons";
import { faBriefcase, faChargingStation, faDollar, faLocation, faLocationDot, faLocationPin, faMapPin, faTimeline, faTimes } from "@fortawesome/free-solid-svg-icons";

const card = [
    { name: "Location", icon: faLocationDot , value: "New York",id:"location" },
    { name: "Experience", icon: faBriefcase , value: "Expert",id:"experience" },
    { name: "Salary", icon: faDollar , value: "48 LPA",id:"packageOffered" },
    { name: "Job Type", icon: faClock , value: "Full-Time",id:"jobType" }
  ];
